...
""", unsafe_allow_html=True)
    ...
    _receipt_body = render_receipt_html(
    ...
    st.markdown(_receipt_body, unsafe_allow_html=True)

    # ── 영수증 HTML 파일 저장 버튼 ──
    _safe_genre = re.sub(r"[^\w\-]", "_", selected_genre)[:20]
    _receipt_full_html = f"""<!DOCTYPE html>
<html lang="ko">
<head>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<link href="https://cdn.jsdelivr.net/gh/orioncactus/pretendard@v1.3.9/dist/web/static/pretendard.min.css" rel="stylesheet">
<title>Digging Receipt — {selected_genre}</title>
<style>
  html, body {{
...
{_receipt_body}
    ...
    st.download_button(
        label="🧾 감성 영수증 저장하기",
        data=_receipt_full_html.encode("utf-8"),
        file_name=f"digging_receipt_{_safe_genre}.html",
        mime="text/html",
